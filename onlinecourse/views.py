...
# The key elements of the login form are two input fields for user name and password. 
...
# Add Registeration request view to handle a registeration POST request.
def registration_request(request):
    ...
    # If it is a POST request
        ...
        # <HINT> Get user information from request.
